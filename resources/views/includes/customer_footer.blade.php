                ...
                <footer class="footer text-center text-sm-left">
                    &copy; 2022 Chaintasker <span class="text-muted d-none d-sm-inline-block float-right">Crafted with <i class="mdi mdi-heart text-danger"></i> by g7technologies.com</span>
                </footer><!--end footer-->
            </div>
            <!-- end page content -->
        </div>
